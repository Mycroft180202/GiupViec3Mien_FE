...
import { User, CheckCircle, XCircle, Mail, Phone, Loader2, AlertCircle, SearchX, Star, ShieldCheck } from 'lucide-react';
...
const EmployerCandidates = () => {
  ...
  const fetchCandidates = async () => {
    ...
    try {
      ...
      console.log('Recruiter Applicants Data:', response.data);
              ...
              <CardBody style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                <div style={{ marginBottom: '1.5rem', flex: 1 }}>
                  <div style={{ fontSize: '0.9rem', color: 'var(--text-main)', marginBottom: '0.65rem' }}>
                    <strong>Tin tuyển:</strong> <Link to={`/viec-lam/${candidate.jobId}`} style={{color: 'var(--primary-color)', textDecoration: 'none'}}>{candidate.jobTitle}</Link>
                  </div>

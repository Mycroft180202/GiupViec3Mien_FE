...
import { Briefcase, Eye, Trash2, Loader2, AlertCircle } from 'lucide-react';
...
const EmployerDashboard = () => {
  ...
  const getStatusLabel = (status) => {
    const labels = {
      0: 'Đang Tuyển', // Open
      1: 'Đang Tới',   // Assigned/InProgress
      2: 'Hoàn Thành',
      3: 'Đã Hủy',
      'Open': 'Đang Tuyển',
      'Assigned': 'Đang Tới'
    ...
    <div className="animate-fade-in">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          ...
          <p className="dashboard-subtitle" style={{ marginBottom: 0 }}>Theo dõi trạng thái và ứng viên cho các công việc bạn đã đăng tuyển.</p>
        </div>
              ...
              <CardBody style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.25rem' }}>
                 <div>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                      ...
                      <span>•</span>
                      <span style={{ color: 'var(--primary-color)', fontWeight: 600 }}>{job.applicantCount} người ứng tuyển</span>
                    </div>
                 </div>
